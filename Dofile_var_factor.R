library(haven)
Infant_M_data_Final <- read_dta("C:/Users/User/Desktop/Stata folder/Infant_M_data_Final.dta")
...
Infant_M_data_Final$Family_Size_factor=factor(Infant_M_data_Final$NUMFamily_Size,levels=c(1,2,3),labels=c("1 - 5","6 - 10","> 10"),ordered=F)

Infant_M_data_Final$Children_Ever_Born_factor=NA
Infant_M_data_Final$Children_Ever_Born_factor=factor(Infant_M_data_Final$NUMChildren_Ever_Born,levels=c(1,2,3),labels=c("1 - 3","4 - 7","> 7"),ordered=F)
